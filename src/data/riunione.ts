...
export const SLIDE: Slide[] = [
...

  {
    ...
    blocco: { titolo: 'Dove siamo oggi, e cosa vuol dire', minuti: 5 },
  },
  {
    tipo: 'punti',
    parte: 'maurizio',
    ...
    titolo: 'Da qui sono andato a lavorare in altri centri',
    righe: [
      'Consulenza, formazione, analisi dei processi',
      'Quello che trovo è completamente diverso da qui',
      'Non lo dico per vanto: è la misura di quanto abbiamo costruito',
      'E da dentro non si vede',
    ],
    nota: 'Del flagship e di come è nata quella parte del mio lavoro si parla a voce: la slide non lo dice. Guardali in faccia sull’ultima riga.',
  },
  {
    tipo: 'punti',
    parte: 'maurizio',
    sezione: 'Dove siamo oggi',
    occhiello: 'La differenza vera',
    titolo: 'L’organizzazione, non la tecnologia',
    righe: [
      'La tecnologia si compra e si installa: è il meno',
      'L’organizzazione funziona solo se si è allineati',
      'Allineati vuol dire tutti, non quasi tutti',
    ],
  },
  {
    tipo: 'punti',
    parte: 'maurizio',
    sezione: 'Dove siamo oggi',
    occhiello: 'Cosa vi dà, ogni giorno',
    titolo: 'In un contesto organizzato si lavora meglio',
    righe: [
      'Meno reattività, più proattività',
      'Si cresce, come persone e come professionisti',
      'Non è un vantaggio del club: è vostro',
    ],
    nota: 'È il punto che di solito non si dice: l’organizzazione la si racconta come un obbligo, e invece la prima cosa che cambia è la giornata di chi ci lavora.',
  },
  {
    tipo: 'punti',
    parte: 'maurizio',
    sezione: 'Dove siamo oggi',
    occhiello: 'Perché ci tengo',
    titolo: 'Le nostre sono attività stagionali',
    righe: [
      'Non possiamo permetterci di non sapere cosa succederà',
      'Quello che chiedo è guardare cosa ci succede intorno, e prevederlo',
      'Da qui la direzione: definire il perimetro, e strutturarlo',
    ],
    nota: 'Questa riga apre il blocco sui processi che arriva più avanti: il perimetro è la stessa cosa, detta due volte a distanza.',
  },
  {
    tipo: 'citazione',
    parte: 'maurizio',
